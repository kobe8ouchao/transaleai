...
function HeaderComponent() {
  ...
  useEffect(() => {
    ...
    const handleUpdateUserInfo = (event: CustomEvent) => {
      ...
      if (user) {
        const userData = JSON.parse(user);
        console.log("updateUserInfo heaer",event.detail.tokens)
                    ...
                    <div className="flex items-center bg-gray-100 px-4 py-2 rounded-full">
                      <div className="flex items-center mr-4">
                        ...
                        <Tooltip 
                          title={
                            <div className="p-2">
                              <p className="text-sm mb-2">{t('tokensDescription')}</p>
                              <ul className="list-disc pl-6 space-y-1">
                                <li>{t('tokensChinese')}</li>
                                <li>{t('tokensEnglish')}</li>
                                <li>{t('tokensPunctuation')}</li>
                              </ul>
                            </div>
                          }
                          placement="bottom"
